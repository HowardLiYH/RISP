...
| Addendum E (X1/X2/X3/X4, withheld era E-F, regional register E-R) | 5c96c35 2026-07-15T13:09-04:00 | e1f804b / 49a640e 14:15 | **GIT-SEPARATED** | Addendum F: X1 neither-branch, X3 anti-branch, X4 confirmed + divergence, E-F 5/6 scorecard. X2 RESOLVED 2026-07-21 (results/e_french49_L3_x2.json + prewar era extension per commit 1155f3c): modern verdict WINDOW (13-17%@h0 through 16-22%@h6; registered 15/h0 inside; island clause dead), prewar verdict WINDOW at h4/h6 only with PX2e anchor-in-window MISS (10% isolated at h0, cell solid on tier-2 re-read); cross-era 13-16% overlap under hysteresis supersedes the relocation narrative (descriptive). E-R Japan resolved separately (Addendum L row) |
...
| CRSP T-split amendment (osf_package/PREREG_CRSP_AMENDMENT_TSPLIT.md) | git 2026-07-16; **OSF-mirrored 2026-07-15 23:35 ET (osf.io/nsx4e)** | — | **FORWARD, third-party custody** (T-split primary design; net register and window estimator fixed pre-data; WRDS expected September) | open. **Window-estimator κ calibration attempted 2026-07-20 (results/window_estimator_calibration.json, calibration-not-claim): INFEASIBLE** — modern needs κ∈(0.129,0.143], prewar κ∈(0.471,0.486]; disjoint, and directionally so (denser prewar crisis occupancy would push θ coarser while the actual paying window moved finer, 15%→10%). Per the amendment's own clause the infeasibility (and any successor rule) must be lodged at osf.io/nsx4e BEFORE CRSP data access; until then only the fixed-15% robustness column has standing |
...
| Addendum L + supplement (E-R Japan operationalization; occupancy/audit clauses; X2 era extension) | L: dfd9fe7 2026-07-20T16:04-04:00 (alone, before any run touched Japanese data); supplement: 1155f3c 16:14 (alone; custody stated inside: post-hoc for Japan, ex-ante for remaining regions and prewar-X2) | results committed 2026-07-20 (after spec pushes) | **GIT-SEPARATED** (Japan battery); supplement's remaining-region and prewar-X2 clauses **FORWARD** | Addendum L verdicts: E-R Japan sign prediction HIT (Γ=−0.000602±0.000162, negative-significant; PL2 branch p=0.25); inversion Holm 3.9e-8; sign rule consistent in 4/4 Japan cells (running scorecard 9/10); cell OCCUPANCY-ANOMALOUS (67.2% crisis occupancy at 15%); structure screen descriptive fail (z=−0.90), fourth screen/pool-value dissociation |
...
| Addendum O (pooled cross-history event-level register; dollar register economically primary) | 851d060 2026-07-21T00:10-04:00 (spec alone, before the script existed; pooling rule fixed before any remaining region downloaded) | results committed 2026-07-21 (after spec push) | **GIT-SEPARATED**; future-region refreshes **FORWARD** | Addendum O verdicts (checkpoint a, n=109): PO1 sign test p=0.0625 FAIL → frequency claim RETIRED program-wide (binding); PO2 Wilcoxon p=0.0086 pass (against 0.35 odds); PO3 dollar CI [−1881,+9977] covers 0 → economic headline restated region-conditional (binding). Japan re-read sanity exact |
| Addendum N (prewar event-level N1, prewar net-cost N2, κ-fallback N3) | 7add739 2026-07-20T16:21-04:00 (spec alone, before the scripts existed) | results committed 2026-07-20 (after spec push) | **GIT-SEPARATED**; N3 fallback **FORWARD for CRSP** (θ estimator retired, fixed-15% primary; OSF mirror owed before WRDS access) | Addendum N verdicts: N1 PN1a/PN1b BOTH MISS — prewar-10% sign test fails (Wilcoxon passes), 1958–89 fails both tests; binding adverse branch taken, both withheld-era positive cells relabeled implementation-precision-only at event level. N2 partial-miss branch in both cells: Γ_net@25bps positive-significant but below gross — D3 amplification refuted out-of-sample; deficit survives the adjudicating register |
