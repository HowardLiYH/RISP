...
threshold $N_p \max_D \Phi(D)/D$ evaluates to $\approx 27\%$ on the
measured E3 grid ($\Phi(21) \approx 0.38$), i.e.\ near $25\%$--$30\%$. The proposition's value is not a universal
